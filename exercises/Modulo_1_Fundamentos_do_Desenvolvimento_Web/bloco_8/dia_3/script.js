...
const fullNamesWithMap = persons.map((person) => `${person.firstName} ${person.lastName}`);

console.log(fullNamesWithMap); // [ 'Maria Ferreira', 'João Silva', 'Antonio Cabral' ]
...
const objectListProduct = (listProducts, listPrices) => listProducts.map((product, index) => (
  { [product]: listPrices[index] }
));

const listProducts = objectListProduct(products, prices);
